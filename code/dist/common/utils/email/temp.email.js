...
const emailTemplate = ({ code, title, }) => {
  ...
  <body>
    <div class="card">
      <div class="header">
        <h1>${config_1.APPLICATION_NAME}</h1>
      </div>
      <div class="body">
        <h2>${title}</h2>
      ...
      <div class="footer">
        ...
        <a href="${config_1.FACEBOOKLINK}" class="social fb"><img src="https://cdn-icons-png.flaticon.com/512/145/145802.png" width="24"></a>
        <a href="${config_1.INSTAGRAM}" class="social ig"><img src="https://cdn-icons-png.flaticon.com/512/2111/2111463.png" width="24"></a>
        <a href="${config_1.TWITTERLINK}" class="social tw"><img src="https://cdn-icons-png.flaticon.com/512/733/733579.png" width="24"></a>
      </div>
    </div>
  </body>
  </html>
