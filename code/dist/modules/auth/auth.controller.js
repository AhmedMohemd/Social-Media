...
router.post("/resend-confirm-email", (0, middleware_1.validation)(validators.resendConfirmEmail), async (req, res, next) => {
...
router.post("/request-forgot-password", (0, middleware_1.validation)(validators.requestForgotPassword), async (req, res) => {
    await auth_service_1.default.requestForgotPassword(req.body);
    return (0, response_1.successResponse)({ res });
});
router.patch("/verify-forgot-password", (0, middleware_1.validation)(validators.verifyForgotPassword), async (req, res) => {
    await auth_service_1.default.verifyForgotPasswordOtp(req.body);
    return (0, response_1.successResponse)({ res });
});
router.patch("/reset-forgot-password", (0, middleware_1.validation)(validators.resetForgotPassword), async (req, res) => {
