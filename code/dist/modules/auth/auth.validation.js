...
exports.resetForgotPassword = exports.verifyForgotPassword = exports.requestForgotPassword = exports.signup = exports.login = exports.confirmEmail = exports.resendConfirmEmail = void 0;
...
exports.signup = {
    ...
    query: zod_1.z.strictObject({ flage: zod_1.z.coerce.boolean() }),
};
exports.requestForgotPassword = {
    body: zod_1.z.strictObject({
        email: validation_1.generalValidationFields.email,
    }),
};
exports.verifyForgotPassword = {
    body: exports.requestForgotPassword.body.safeExtend({
        otp: validation_1.generalValidationFields.otp,
    }),
};
exports.resetForgotPassword = {
    body: exports.requestForgotPassword.body
        .safeExtend({
        password: validation_1.generalValidationFields.password,
        confirmPassword: validation_1.generalValidationFields.confirmPassword,
    })
